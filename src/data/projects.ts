...
export const projects: Project[] = [
  {
    ...
    features: [
      ...
      },
      {
        ...
        why: 'Нужна база знаний по музыкальной литературе, структура данных в которой не привязана к БД (универсальна) Файловая система сама по себе — иерархическая структура с вложенными папками — идеально ложится на навигацию по разделам.'
      },
      {
